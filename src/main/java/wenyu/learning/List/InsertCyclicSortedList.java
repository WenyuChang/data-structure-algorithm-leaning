 ...
 * 
 * Problem 2: Insert a new node into a cyclic sorted link. One node in link (could be any one node in the link) is given.
 */
...
public class InsertCyclicSortedList {
	...
	public static void main(String[] args) {
		MyListNode<Integer> head = DemoUtils.generateLinkedList(false, 1);
		prepareLink(head);
