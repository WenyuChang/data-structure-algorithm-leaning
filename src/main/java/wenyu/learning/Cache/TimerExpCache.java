...
public class TimerExpCache {
	private static ConcurrentHashMap<String, CacheUnit> cacheMgmt;
	private static Timer timer = new Timer(true);
	/**
	 * Singleton entry.
	 */
	public static TimerExpCache getInstance() {
		return instance;
	}
	private static TimerExpCache instance = new TimerExpCache();
	
	/**
	 * Constructor.
	 */
	private TimerExpCache() {
