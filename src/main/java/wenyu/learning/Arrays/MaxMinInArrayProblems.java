 ...
 *
 * Problem 3: Find min and max element of an unsorted integer array
 * Logic:
 * 	  Solution 1: using 2n times compare
 * 	  Solution 2: using 3n/2 times compare
 */
...
class MaxDiffInArraySequence {
	/*
	 * The array sequence means we should keep the order of origin array. (Same as stock problem)
	...
	public static void maxDiffSeq_solution2(int numbers[]) {
		if (numbers == null || numbers.length < 2) {
			...
			System.out.println("Max difference is " + (numbers[0] <= numbers[1] ? numbers[1]-numbers[0] : 0));
		}
...
class MaxMinFindingFromUnsortedArray {
...
public class MaxMinInArrayProblems {
	public static void main(String[] args) {
