...
public class MinDiffInTwoArrays {
	public static int findWithSort(int[] arr1, int[] arr2, boolean print) {
		Arrays.sort(arr1);
		Arrays.sort(arr2);
		...
		if(print) System.out.println("The min difference is " + minDiff + " (" + arr1[minDiff1] + " and " + arr2[minDiff2] + ").");
		return minDiff;
	}
