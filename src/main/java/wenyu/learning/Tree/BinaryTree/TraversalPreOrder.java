...
public class TraversalPreOrder {
	public static <E> void traversalWithRecursion(BinaryTreeNode<E> node, TraversalOperation<E> op) {
		if(node == null) {
			return;
		}
	...
	public static <E> void traversalWithoutRecursion(BinaryTreeNode<E> root, TraversalOperation<E> op) {
		if(root == null) {
			return;
		}
