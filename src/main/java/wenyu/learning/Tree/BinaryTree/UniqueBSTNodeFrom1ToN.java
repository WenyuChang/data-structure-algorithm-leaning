 ...
 * Problem1: Get the number of unique binary search tree count
 * Problem2: Get all the unique binary search tree
 */
public class UniqueBSTNodeFrom1ToN {

    public static int problem1_count(int n) {
        /*
        Logic:
    ...
    public static <E> List<BinaryTreeNode<E>> problem2(int n) {
